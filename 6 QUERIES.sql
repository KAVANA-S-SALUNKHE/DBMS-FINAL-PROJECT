...
T10_CUSTOMER ,T10_VEHICLE ,T10_CLAIM,T10_INCIDENT_REPORT 
WHERE T10_CLAIM.T10_7_Claim_Status='Pending'AND T10_CLAIM.T10_1_Cust_Id=T10_CUSTOMER.T10_1_Cust_Id 
AND T10_CUSTOMER.T10_1_Cust_Id=T10_VEHICLE.T10_6_Cust_Id AND T10_CUSTOMER.T10_1_Cust_Id = T10_INCIDENT_REPORT.T10_1_Cust_Id;

# QUERY 2
select T10_CUSTOMER.* from T10_CUSTOMER 
WHERE T10_1_Cust_Id IN (SELECT T10_1_Cust_Id from T10_PREMIUM_PAYMENT
 WHERE  T10_PREMIUM_PAYMENT.T10_5_Premium_Payment_Amount > ANY(SELECT SUM(T10_1_Cust_Id) 
 FROM T10_CUSTOMER));
        
# QUERY 3
select * from  T10_INSURANCE_COMPANY
...
# QUERY 5
SELECT T10_VEHICLE.*,T10_5_Premium_Payment_Amount 
FROM T10_VEHICLE,T10_PREMIUM_PAYMENT 
WHERE (T10_5_Premium_Payment_Amount > T10_6_Vehicle_Number
 AND  T10_PREMIUM_PAYMENT.T10_1_Cust_Id = T10_VEHICLE.T10_6_Cust_Id );

# QUERY 6
select * from T10_CUSTOMER where T10_1_Cust_Id 
    in (select distinct (T10_CLAIM .T10_1_Cust_Id)
	from T10_CLAIM , T10_CLAIM_SETTLEMENT , T10_COVERAGE 
    where T10_CLAIM.T10_7_Claim_Amount > T10_CLAIM_SETTLEMENT.T10_8_Claim_Settlement_Id + T10_CLAIM_SETTLEMENT.T10_6_Vehicle_Id + T10_CLAIM.T10_7_Claim_Id + T10_CLAIM.T10_1_Cust_Id 
    and T10_16_Coverage_Amount > T10_CLAIM.T10_7_Claim_Amount );